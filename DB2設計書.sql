...
*******    );
*******--- 初期データ登録（サンプル口座残高）
*******    INSERT INTO MYDB.DB_ACCOUNT_BALANCE (
*******                                         ACC_ID, 
*******                                         BALANCE
*******                                        )
...
*******--- 預金種別（例：NON-TERM, FIXED-03）
*******        SAVING_TYPE   CHAR(10)     NOT NULL, 
*******--- 年利率（例：0.0080 = 0.8%）
*******        INTEREST_RATE DECIMAL(5,4) NOT NULL, 
*******        CONSTRAINT PK_INTEREST_INFO PRIMARY KEY (SAVING_TYPE)
*******    );
*******--- 初期データ登録（利率マスタ）
*******    INSERT INTO MYDB.DB_INTEREST_INFO (
*******                                       SAVING_TYPE, 
*******                                       INTEREST_RATE
*******                                      )
...
*******--- 元本
*******        MONEY_ROOT    DECIMAL(15,2) NOT NULL, 
*******--- 計算済利息
*******        INTEREST      DECIMAL(15,2) NOT NULL, 
*******--- 元利合計（MONEY_ROOT + INTEREST）
...
*******                                         STATUS
*******                                        )
*******        SELECT 41, 4001, 'NON-TERM', '20240901', '20240901',  800000, 0.00, 0.00, '1' FROM SYSIBM.SYSDUMMY1
*******            UNION ALL
*******        SELECT 42, 4001, 'FIXED-06', '20240401', '20241001', 2300000, 0.00, 0.00, '1' FROM SYSIBM.SYSDUMMY1
*******            UNION ALL
*******        SELECT 43, 4001, 'FIXED-12', '20240101', '20250101', 4500000, 0.00, 0.00, '1' FROM SYSIBM.SYSDUMMY1
*******            UNION ALL
*******        SELECT 44, 4002, 'FIXED-03', '20240701', '20241001', 1700000, 0.00, 0.00, '1' FROM SYSIBM.SYSDUMMY1
*******            UNION ALL
*******        SELECT 45, 4002, 'NON-TERM', '20240915', '20240915',  600000, 0.00, 0.00, '1' FROM SYSIBM.SYSDUMMY1
*******            UNION ALL
*******        SELECT 46, 4003, 'FIXED-06', '20240501', '20241101', 2900000, 0.00, 0.00, '1' FROM SYSIBM.SYSDUMMY1
*******            UNION ALL
*******        SELECT 47, 4003, 'FIXED-12', '20240201', '20250201', 5800000, 0.00, 0.00, '1' FROM SYSIBM.SYSDUMMY1
*******            UNION ALL
*******        SELECT 48, 4004, 'NON-TERM', '20241005', '20241005',  900000, 0.00, 0.00, '1' FROM SYSIBM.SYSDUMMY1
*******            UNION ALL
*******        SELECT 49, 4004, 'FIXED-03', '20240801', '20241101', 1300000, 0.00, 0.00, '1' FROM SYSIBM.SYSDUMMY1
*******            UNION ALL
*******        SELECT 50, 4005, 'FIXED-06', '20240601', '20241201', 3600000, 0.00, 0.00, '1' FROM SYSIBM.SYSDUMMY1
*******            UNION ALL
*******        SELECT 51, 4005, 'FIXED-12', '20240101', '20250101', 6000000, 0.00, 0.00, '1' FROM SYSIBM.SYSDUMMY1
*******            UNION ALL
*******        SELECT 52, 4005, 'NON-TERM', '20240920', '20240920',  700000, 0.00, 0.00, '1' FROM SYSIBM.SYSDUMMY1;
*******--- =========================================================
*******--- 確認用SELECT（処理結果確認用）
*******--- =========================================================
