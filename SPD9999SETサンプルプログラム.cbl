...
000000    03 WS-PARAM-ACCID-COMP       PIC S9(09)       COMP. 
000000*/-------------------------------------------------------------/*
000000*  ホスト変数                                                    
000000*/-------------------------------------------------------------/*     
...
000000    03 CST-FUNC-PREVIEW          PIC X(01)  VALUE '1'.
000000    03 CST-FUNC-SETTLE           PIC X(01)  VALUE '2'.
000000    03 CST-FUNC-BOTH             PIC X(01)  VALUE '3'.
...
000000         STOP RUN
000000     END-IF.
000000     IF  WS-PARAM-FUNC NOT = CST-FUNC-PREVIEW
000000     AND WS-PARAM-FUNC NOT = CST-FUNC-SETTLE
000000     AND WS-PARAM-FUNC NOT = CST-FUNC-BOTH
...
000000         FROM    MYDB.DB_ACCOUNT_SAVINGS  
000000         WHERE   STATUS = :CST-STATUS-1
000000         AND     ACC_ID = :WS-PARAM-ACCID-COMP             
000000     END-EXEC.                                            
000000     EXEC SQL                                             
000000         OPEN CRS2                                        
000000     END-EXEC.
